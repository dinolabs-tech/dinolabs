...
if (isset($_POST["message"])) {
    ...
    try {
        ...
        $mailToAdmin->isSMTP();
        $mailToAdmin->Host       = 'mail.dinolabstech.com'; // <-- change this
        $mailToAdmin->SMTPAuth   = true;
        $mailToAdmin->Username   = 'enquiries@dinolabstech.com'; // <-- change this
        $mailToAdmin->Password   = 'Dinolabs@11';     // <-- change this
        ...
        $mailToUser->isSMTP();
        $mailToUser->Host       = 'mail.dinolabstech.com'; // <-- change this
        $mailToUser->SMTPAuth   = true;
        $mailToUser->Username   = 'enquiries@dinolabstech.com'; // <-- change this
        $mailToUser->Password   = 'Dinolabs@11';     // <-- change this
        ...
        $mailToUser->Body = "
            <p>Dear $user_name,</p>
            <p>Thank you for reaching out to us! We appreciate the time you took to share your feedback and inquiries with Dinolabs Tech Services</p>
