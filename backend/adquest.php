...
$distinctCourses = [];
$result = $conn->query("SELECT DISTINCT id, course_name FROM courses");
if ($result) {
...
// if (isset($_GET['course']) && $_GET['course'] !== "") {
  ...
  $where[] = "course='" . $conn->real_escape_string($_GET['course']) . "'";
}
                  ...
                  <div class="mb-4 mt-2">
                    ...
                    <form method="GET" action="" class="row g-3">
                      <div class="mb-3 col-md-8">
                        <select name="course" id="class" class="form-select" required>
                          <option value="" selected disabled>Select Course</option>
                          <?php foreach ($distinctCourses as $courseOption): ?>
                            <option value="<?php echo htmlspecialchars($courseOption['id']); ?>" <?php if (isset($_GET['course']) && $_GET['course'] == $courseOption['id']) echo 'selected'; ?>>
                              <?php echo htmlspecialchars($courseOption['course_name']); ?>
                            </option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    ...
                    <div id="editFormContainer" class="card mt-4" style="display: none;">
                      ...
                      <div class="card-body">
                        <form id="editForm" method="POST" action="" class="row g-3">
                          ...
                          <div class="col-md-4">
                            <button type="submit" name="update_question" class="btn btn-success mt-4"><span class="btn-label">
                                <i class="fa fa-sync-alt"></i>Update Question</button>
                            <button type="button" id="cancelEdit" class="btn btn-secondary mt-4"> <span class="btn-label">
