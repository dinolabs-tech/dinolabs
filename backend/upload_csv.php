...
if (!isset($_FILES['csvFile']) || $_FILES['csvFile']['error'] !== UPLOAD_ERR_OK) {
    ...
    $class       = isset($_POST['class'])   ? mysqli_real_escape_string($conn, $_POST['course']) : '';
    ...
    if (($handle = fopen($csvFile, "r")) !== false) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $query = "INSERT INTO question (
                            subject, que_desc, ans1, ans2, ans3, ans4, true_ans, course
                      ) VALUES (
                            '$subject', '$que_desc', '$ans1', '$ans2', '$ans3', '$ans4', '$true_ans', '$class'
                      )";
